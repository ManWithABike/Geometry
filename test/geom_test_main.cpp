...
void test_basic_funcionality(){
	...
	geom::Vec<double, 3> vec3d_1{ { 0,1,2 } }; //Irgendwie moeglich hier die 3 zu deduzieren? (Laenge des uebergebenen Vektors)
	geom::Vec<double, 3> vec3d_2{ {-1,-1,-1} };
